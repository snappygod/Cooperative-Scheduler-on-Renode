...
void Task1(){
  if (buttonPressed) 
	{
		uint8_t msg[] = "QueDelayTask2 !!\n";
		sendUART(msg, sizeof(msg));
		QueDelay(Task2, 4);
  }
  else
	{
		uint8_t msg[] = "ReRunTask1 !!\n";
		sendUART(msg, sizeof(msg));
    ReRunMe(4);
	}
}
...
void Task2() {
  if (buttonPressed) 
	{
		uint8_t msg[] = "QueDelayTask1 !!\n";
		sendUART(msg, sizeof(msg));
		QueDelay(Task1, 3);
   }
   else
	 {
		 uint8_t msg[] = "ReRunTask2 !!\n";
		 sendUART(msg, sizeof(msg));
     ReRunMe(3);
	 }
}
...
void Task3(void){
  if (buttonPressed) 
	{
		uint8_t msg[] = "QueDelayTask4 !!\n";
		sendUART(msg, sizeof(msg));
		QueDelay(Task4, 2);
  }
  else
	{
		uint8_t msg[] = "ReRunTask3 !!\n";
		sendUART(msg, sizeof(msg));
    ReRunMe(2);
	}
}
...
void Task4(void){
  if (buttonPressed) 
	{
		uint8_t msg[] = "QueDelayTask3 !!\n";
		sendUART(msg, sizeof(msg));
		QueDelay(Task3, 1);
  }
  else
	{
		uint8_t msg[] = "ReRunTask4 !!\n";
		sendUART(msg, sizeof(msg));
    ReRunMe(1);
	}
}
